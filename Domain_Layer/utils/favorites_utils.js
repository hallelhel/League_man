...
//   let player_data = players_info.map((player) => {
//     return player.data.data;
//   });
//   return players_utils.extractRelevantPlayerData(player_data);
// }

// async function getFavoritesUserTeams_ids(username) {
//   //return list of teams ids that are in db favorite of the user
...
// async function markTeamAsFavorite(username, teamID) {
//   //add (username,team_id) to db
...
// async function markGameAsFavorite(username, GameID) {
//   //add (username,GameID) to db
//   let GameExist = await games_utils.getGameDetaildByID(GameID);
//   if (GameExist == "Game does not exist in DB") {
//     return false;
//   }
//   try {
//     await DButils.execQuery(
...
// async function getFavoritesUserGames_ids(username) {
//   //return list of games ids that are in db favorite of the user
